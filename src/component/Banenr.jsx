...
const Banenr = () => {
    return (
        <>
            <div className="box py-8 sm:py-12 md:py-16 lg:py-20" style={{
                ...
                <div className="w-full md:w-1/2 order-2 md:order-1">
                    <Flex>
                        <div className="px-4 md:px-6 lg:px-10 pb-8 md:pb-0">
                            <h1 className='font-brad leading-5 md:leading-6 lg:leading-7 text-[20px] md:text-[24px] lg:text-[28px] text-[#0F0200] mb-1 md:mb-2'><span className='w-10 md:w-12 lg:w-14 h-0.5 md:h-1 bg-purple-600 inline-block items-center mr-2'></span>Welcome to The</h1>
                            <h1 className='font-brad text-[#212529] text-3xl md:text-4xl lg:text-5xl leading-tight'>Classic <span className='text-[#F83D8E]'>Ice <br className="md:hidden"/>
                            Cream</span> Parlor</h1>
                            <p className='text-[13px] md:text-[15px] lg:text-[18px] text-[#0F0200] font-apa leading-5 md:leading-6 lg:leading-7 mt-4 md:mt-6 lg:mt-8 max-w-md'>
