            ...
            <Container>
                <Flex className="flex-col md:flex-row items-center">
                    ...
                    <div className="w-full md:w-1/2 mt-4 md:mt-[50px] px-4 md:px-6 lg:px-10">
                        <h1 className='font-brad text-[#0F0200] text-[20px] md:text-[24px] lg:text-[32px]'>Relive the Sweet <br className="md:hidden" />
                        ...
                        <button className='bg-[#F83D8E] flex items-center gap-2 py-1 md:py-2 px-2 md:px-4 rounded-full text-white font-apa font-semibold text-[10px] md:text-[12px] lg:text-[14px] shadow-md transition-all duration-300 hover:shadow-[0_5px_15px_rgba(248,61,142,0.6)] mt-4 md:mt-6'>
