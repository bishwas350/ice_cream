...
const Footer = () => {
  return (
    <div className='bg-[url("./assets/img/Section.png")] bg-cover bg-no-repeat py-8 md:py-12 lg:py-16'>

      <Container>
        <Flex className={"flex-col lg:flex-row items-center justify-center lg:justify-between xl:justify-around gap-8 md:gap-10 lg:gap-4 px-4 md:px-6 lg:px-8"}>
          ...
          <div className="w-full lg:w-auto">
            ...
            <Flex className={'flex-col md:flex-row gap-8 md:gap-12 lg:gap-16'}>
              <div className="w-full md:w-auto">
                ...
                <ul className='text-center text-[14px] md:text-base font-apa text-[#CFB6E2] flex flex-col gap-2'>
              ...
              <div className="w-full md:w-auto flex flex-col gap-8">
                <div className="flex flex-col items-center">
                  <IoLocationSharp className='text-2xl md:text-3xl text-white mb-2' />
                  <h3 className='text-[#CFB6E2] text-xl md:text-2xl font-apa mb-2'>Address</h3>
                  <div>
                    <p className='text-[#CFB6E2] text-sm md:text-base font-apa text-center max-w-[200px]'>
                      121 King Street Melbourne, 3000, Australia
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-center">
                  <MdEmail className='text-2xl md:text-3xl text-white mb-2' />
              ...
              <div className="flex flex-col items-center w-full md:w-auto">
                <FaPhone className='text-2xl md:text-3xl text-white mb-2' />
